...
ANDROID_NDK_ROOT    = /cygdrive/C/android-ndk-r4b
TEMP_DIR       		= ../../Temp/Android
SRCROOT             = ../../Sources
S3DXROOT            = ../../Sources/S3DX
BUILT_PRODUCTS_DIR  = ../../Contents/Android
PRODUCT_NAME        = ShivaKinect_Android.a

#################################################################
SOURCES				= Plugin.cpp shivakinect.cpp 
...
CFLAGS_Common		= --sysroot="$(SYSROOT)" $(CFLAGS_Arch) -Os -Wno-unknown-pragmas -fsigned-char -fno-strict-aliasing -fno-short-enums -fno-exceptions -DANDROID_NDK -DANDROID -DRELEASE -D_GNU_SOURCE -DHAVE_STDINT_H
