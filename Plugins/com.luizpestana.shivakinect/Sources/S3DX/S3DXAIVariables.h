...
//-----------------------------------------------------------------------------
{
    ...
    public :
        ...
        template< uint8 _iCount2 > inline AIVariables ( const AIVariables< _iCount2 > &_oValue ) 
        { 
        ...
        template< uint8 _iCount2 > inline AIVariables &operator = ( const AIVariables< _iCount2 > &_oValue ) 
        { 
            const uint8 iMax = ( _iCount < _iCount2 ) ? _iCount : _iCount2 ;
            for ( uint8 i = 0 ; i < iMax ; i++ )
            {
